...
[centers_inner, radii_inner, metric_inner] = imfindcircles(image,[45 50], 'ObjectPolarity','dark','Sensitivity',0.98,'EdgeThreshold',0.01);
[centers_outer, radii_outer, metric_outer] = imfindcircles(image,[100 160],'ObjectPolarity','dark','Sensitivity',0.96,'EdgeThreshold',0.00000000001);
...
[Px, Py] = snake_pgm('images/iris5.bmp');
...
outer_boundary = ceil(radii_inner*2.51);
